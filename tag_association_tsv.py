...
def main():
    ...
    parser.add_argument('-tdf', '-tags_df', type=str, dest='tagsDF_path', help='Specify the path to the tags.tsv adn tags_obj.tsv file (the file with all the tags number and names)')
