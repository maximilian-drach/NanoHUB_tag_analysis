...
def main():
    ...
    parser.add_argument('-path', '-t_path', '-tagsTSV_path', type=str, dest='tagsTSV_path', help='Specify the path to the tags.tsv and tags_obj.tsv file (the file with all the tags number and names)')
